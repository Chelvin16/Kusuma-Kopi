      ...
      <div className="mx-auto flex size-full max-w-full items-center justify-between">
        ...
        <div className="absolute hidden h-screen overflow-auto border-b border-border-primary bg-background-primary px-[5%] pb-24 pt-4 md:pb-0 lg:static lg:ml-6 lg:flex lg:h-auto lg:flex-1 lg:items-center lg:justify-between lg:border-none lg:bg-none lg:px-0 lg:pt-0">
                      ...
                      <div className="grid flex-1 auto-cols-fr grid-cols-1 gap-x-8 gap-y-6 py-4 md:grid-cols-3 md:gap-y-0 md:py-8 lg:pr-8">
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Beranda</h5>
                              <p className="hidden text-sm md:block">
                                Kembali ke halaman depan Kusuma Kopi
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">
                                Pelajari cerita dan nilai kami
                              </h5>
                              <p className="hidden text-sm md:block">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Lihat semua pilihan minuman dan makanan
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Hubungi kami untuk pertanyaan atau pesanan
                              </p>
                            </div>
                          </a>
                        </div>
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="hidden text-sm md:block">
                                Tonton konten menarik kami di TikTok
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Lainnya</h5>
                              <p className="hidden text-sm md:block">
                                Lorem ipsum dolor sit amet consectetur elit
                              </p>
                            </div>
                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Galeri</h5>
                              <p className="hidden text-sm md:block">
                                Lihat momen indah di Kusuma Kopi
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Lokasi</h5>
                              <p className="hidden text-sm md:block">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Testimonial</h5>
                              <p className="hidden text-sm md:block">
                                Dengarkan cerita pelanggan setia kami
                              </p>
                            </div>
                          </a>
                          <a
                            ...
                            <a href="#" className="flex flex-col py-2">
                              ...
                              <div className="mt-2 flex max-w-[18rem] flex-col justify-start md:mt-0">
                                <h5 className="mb-1 font-semibold">
                                  Baileys Dream Coffee
                                </h5>
                                <p className="text-sm">
                                  Minuman signature kami yang paling dicintai
                                </p>
                                <div className="mt-2">
                                  <Button
          ...
          <div className="flex items-center gap-4">
            <Button title="Daftar" variant="secondary" size="sm">
              Daftar
            </Button>
