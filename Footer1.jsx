        ...
        <div className="grid grid-cols-1 gap-x-[8vw] gap-y-12 pb-12 md:gap-y-16 md:pb-18 lg:grid-cols-[0.75fr_1fr] lg:gap-y-4 lg:pb-20">
          <div className="flex flex-col">
            ...
            <p className="mb-5 md:mb-6">
              Dapatkan penawaran eksklusif dan cerita terbaru dari Kusuma Kopi.
            </p>
            <div className="w-full max-w-md">
              ...
              >
                ...
                />
                <Button title="Langgani" variant="secondary" size="sm">
                  Langgani
                </Button>
              </form>
              <p className="text-xs">
                Dengan berlangganan, anda menyetujui kebijakan privasi kami dan
                memberikan izin untuk menerima pembaruan.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-1 items-start gap-y-10 sm:grid-cols-3 sm:gap-x-6 md:gap-x-8 md:gap-y-4">
            ...
            <div className="flex flex-col items-start justify-start">
              <h2 className="mb-3 font-semibold md:mb-4">Ikuti kami</h2>
